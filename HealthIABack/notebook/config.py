...
# UUID en CHAR(36) pour MySQL, avec collation identique partout
UUID_TYPE = CHAR(36)
...
class Practice(Base):
    ...
    id_utilisateur = Column(UUID_TYPE, ForeignKey("utilisateurs.id_utilisateurs"))
...
class User(Base):
    ...
    id_utilisateurs = Column(UUID_TYPE, primary_key=True, default=lambda: str(uuid.uuid4()))
...
class ExerciseSession(Base):
    ...
    id_exercice_sessions   = Column(UUID_TYPE, primary_key=True, default=lambda: str(uuid.uuid4()))
